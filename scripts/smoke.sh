#!/bin/sh
# Smoke test for CH-01 and CH-03: brings the real Docker Compose stack up and
# checks every scenario in openspec/changes/CH-01-app-scaffolding-and-environment/
# specs/project-environment/spec.md and openspec/changes/
# CH-03-connection-registration-and-test/specs/connection-registration/spec.md
# against it. Requires Docker running and a local .env (copy .env.example if you
# don't have one yet).
set -e
