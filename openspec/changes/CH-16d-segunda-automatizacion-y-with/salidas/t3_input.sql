...
-- guarda: si el UPDATE no dejó el stock en 8, la división por cero (no constante, para que no se pliegue al planificar) corta el script y la transacción se descarta
